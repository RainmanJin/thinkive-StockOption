...
public class Function60001 extends BaseFunction
{
	...
	public void service(Request req, Response resp)
	{
		...
		StockOption[] tempList = (StockOption[]) HQDataCache.getData(sortStr);
		
		List<StockOption> stockList = MarketUtil.getStockPageList(tempList, typeArray, order, rowOfPage, curPage, sort);
