 ...
 * @创建时间: 上午9:29:31
 */
public class Function60004 extends BaseFunction {
    private static Logger logger = Logger.getLogger(Function60004.class);
    ...
    public void service(Request req, Response resp) {
        ...
        int count = getIntParameter(request, "start", 0); //起始位置
            ...
            if (dealList != null) {
                ...
                if (count < length) {
                    for (int i = count; i < length; i++) {
                        DealData data = (DealData) dealList.get(i);
